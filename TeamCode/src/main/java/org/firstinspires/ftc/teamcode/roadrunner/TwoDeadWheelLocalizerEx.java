...
import org.firstinspires.ftc.teamcode.library.config.EncoderConfigKt;
...
@Config
public final class TwoDeadWheelLocalizerEx implements Localizer {
    ...
    public TwoDeadWheelLocalizerEx(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d pose) {
        // TODO: make sure your config has **motors** with these names (or change them)
        //   the encoders should be plugged into the slot matching the named motor
        //   see https://ftc-docs.firstinspires.org/en/latest/hardware_and_software_configuration/configuring/index.html
        DriveHardwareConfig config = WonderConfigKt.getRobotHardwareConfigWonder().getDrive();

        par = new OverflowEncoder((RawEncoder) EncoderConfigKt.createEncoderUsingConfig(hardwareMap, config.getParEncoder()));
        perp = new OverflowEncoder((RawEncoder) EncoderConfigKt.createEncoderUsingConfig(hardwareMap, config.getPerpEncoder()));
