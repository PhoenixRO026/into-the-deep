...
@Autonomous
class RedRightV4_tarat : LinearOpMode() {
    private val startPose = Pose(20.cm, -59.5.inch, 90.deg)
    private val firstSpecimenBeforePos = Pose(4.inch, -40.inch, 90.deg)
    private val firstSpecimenPos = Pose(0.inch, -30.inch, 90.deg)
    private val secondSpecimenPos = Pose(2.inch, -30.inch, 90.deg)
    private val thirdSpecimenPos = Pose(4.inch, -31.inch, 90.deg)
    private val forthSpecimenPos = Pose(-2.inch, -31.inch, 90.deg)
    private val red1Pos = Distance2d(49.5.inch, -22.5.inch)
    private val red2Pos = Distance2d(65.inch, -19.inch)
    private val red3Pos = Distance2d(69.inch, -23.inch)
