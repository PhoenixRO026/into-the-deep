...
/** @noinspection unused*/
@Config
public final class PinpointLocalizer2 implements Localizer {
    public static class Params {
        public double parYTicks = 30.78211; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -87.120195; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer2(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
