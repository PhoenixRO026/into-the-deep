...
@Autonomous
class RedRightParking : LinearOpMode() {
    val startPose = Pose(27.0.inch, -60.0.inch, 90.0.deg)
    ...
    override fun runOpMode() {
        ...
        val action = mecanumDrive.actionBuilder(startPose.pose2d).ex()
            .setTangent(0.0.deg)
            .turnTo(0.0)
            .afterTime(0.0,robot.intake.extendoToPosAction(values.intake.extendoLim))
            .build()
