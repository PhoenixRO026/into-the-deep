...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick =  0.024163385528974828;
        public double trackWidthTicks = 282.3540378209848;

        // feedforward parameters (in tick units)
        public double kS = 1.7389061921490394;
        public double kV = 0.004890606833467757;
        public double kA = 0.00096;
        ...
        public double maxAngVel = Math.PI * 3.0 / 2.0; // shared with path
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if ((t >= timeTrajectory.duration && error.position.norm() < 1
                    && robotVelRobot.linearVel.norm() < 0.5 && Math.abs(error.heading.toDouble()
            ) < Math.toRadians(5))
                    || t >= timeTrajectory.duration + correctionTimeSec) {
