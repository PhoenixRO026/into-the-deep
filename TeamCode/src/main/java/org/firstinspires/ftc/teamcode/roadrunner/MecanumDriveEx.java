...
import org.firstinspires.ftc.teamcode.library.config.MotorConfigKt;
...
public final class MecanumDriveEx {
    ...
    public static class Params {
        ...
        public double lateralInPerTick = 0.025739365681044186;
        public double trackWidthTicks = 328.689285771;

        // feedforward parameters (in tick units)
        public double kS = 1.5505428451618086;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveEx.this.rightFront));
    ...
    public MecanumDriveEx(HardwareMap hardwareMap, Pose2d pose, Telemetry telemetry) {
        ...
        rightBack = hardwareMap.get(DcMotorEx.class, drive.getMotorRB().getDeviceName());
        rightFront = hardwareMap.get(DcMotorEx.class, drive.getMotorRF().getDeviceName());
        ...
        leftFront.setDirection(MotorConfigKt.toMotorDirection(drive.getMotorLF().getDirection()));
        leftBack.setDirection(MotorConfigKt.toMotorDirection(drive.getMotorLB().getDirection()));
        rightBack.setDirection(MotorConfigKt.toMotorDirection(drive.getMotorRB().getDirection()));
        rightFront.setDirection(MotorConfigKt.toMotorDirection(drive.getMotorRF().getDirection()));
